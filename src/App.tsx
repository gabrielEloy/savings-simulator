...
import main from "./colorPalletes/main";
...
const App = (props: Props) => {
  ...
  return (
    <Wrapper>
      <Header />
      <Subtitle className="subtitle" color="#1B31A8">Let's plan your <strong>saving goal.</strong></Subtitle>
      <div className="content">
        <div className="simulator-container">
          ...
          <div className="montly-amout-container">
            ...
            <div className="desc">
              <Caption>
                You’re planning <strong>{monthsAhead} monthly deposits</strong> to reach
                your <strong>{monthlyAmount}</strong> goal by{" "}
